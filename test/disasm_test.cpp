...
TEST(disasm, opcode16)
{
    ...
    test_disasm(0x1800, "add r0, r0, r0");
    test_disasm(0x1801, "add r1, r0, r0");
    test_disasm(0x1807, "add r7, r0, r0");
    test_disasm(0x1808, "add r0, r1, r0");
    test_disasm(0x1809, "add r1, r1, r0");
    test_disasm(0x180f, "add r7, r1, r0");
    test_disasm(0x1838, "add r0, r7, r0");
    test_disasm(0x1839, "add r1, r7, r0");
    test_disasm(0x183f, "add r7, r7, r0");
    test_disasm(0x1840, "add r0, r0, r1");
    test_disasm(0x1841, "add r1, r0, r1");
    test_disasm(0x1847, "add r7, r0, r1");
    test_disasm(0x1848, "add r0, r1, r1");
    test_disasm(0x1849, "add r1, r1, r1");
    test_disasm(0x184f, "add r7, r1, r1");
    test_disasm(0x1878, "add r0, r7, r1");
    test_disasm(0x1879, "add r1, r7, r1");
    test_disasm(0x187f, "add r7, r7, r1");
    test_disasm(0x19c0, "add r0, r0, r7");
    test_disasm(0x19c1, "add r1, r0, r7");
    test_disasm(0x19c7, "add r7, r0, r7");
    test_disasm(0x19c8, "add r0, r1, r7");
    test_disasm(0x19c9, "add r1, r1, r7");
    test_disasm(0x19cf, "add r7, r1, r7");
    test_disasm(0x19f8, "add r0, r7, r7");
    test_disasm(0x19f9, "add r1, r7, r7");
    test_disasm(0x19ff, "add r7, r7, r7");

    test_disasm(0x1a00, "sub r0, r0, r0");
    test_disasm(0x1a01, "sub r1, r0, r0");
    test_disasm(0x1a07, "sub r7, r0, r0");
    test_disasm(0x1a08, "sub r0, r1, r0");
    test_disasm(0x1a09, "sub r1, r1, r0");
    test_disasm(0x1a0f, "sub r7, r1, r0");
    test_disasm(0x1a38, "sub r0, r7, r0");
    test_disasm(0x1a39, "sub r1, r7, r0");
    test_disasm(0x1a3f, "sub r7, r7, r0");
    test_disasm(0x1a40, "sub r0, r0, r1");
    test_disasm(0x1a41, "sub r1, r0, r1");
    test_disasm(0x1a47, "sub r7, r0, r1");
    test_disasm(0x1a48, "sub r0, r1, r1");
    test_disasm(0x1a49, "sub r1, r1, r1");
    test_disasm(0x1a4f, "sub r7, r1, r1");
    test_disasm(0x1a78, "sub r0, r7, r1");
    test_disasm(0x1a79, "sub r1, r7, r1");
    test_disasm(0x1a7f, "sub r7, r7, r1");
    test_disasm(0x1bc0, "sub r0, r0, r7");
    test_disasm(0x1bc1, "sub r1, r0, r7");
    test_disasm(0x1bc7, "sub r7, r0, r7");
    test_disasm(0x1bc8, "sub r0, r1, r7");
    test_disasm(0x1bc9, "sub r1, r1, r7");
    test_disasm(0x1bcf, "sub r7, r1, r7");
    test_disasm(0x1bf8, "sub r0, r7, r7");
    test_disasm(0x1bf9, "sub r1, r7, r7");
    test_disasm(0x1bff, "sub r7, r7, r7");
    ...
    test_disasm(0x1c40, "add r0, r0, #1");
    test_disasm(0x1c41, "add r1, r0, #1");
    test_disasm(0x1c47, "add r7, r0, #1");
    test_disasm(0x1c48, "add r0, r1, #1");
    test_disasm(0x1c49, "add r1, r1, #1");
    test_disasm(0x1c4f, "add r7, r1, #1");
    test_disasm(0x1c78, "add r0, r7, #1");
    test_disasm(0x1c79, "add r1, r7, #1");
    test_disasm(0x1c7f, "add r7, r7, #1");
    test_disasm(0x1dc0, "add r0, r0, #7");
    test_disasm(0x1dc1, "add r1, r0, #7");
    test_disasm(0x1dc7, "add r7, r0, #7");
    test_disasm(0x1dc8, "add r0, r1, #7");
    test_disasm(0x1dc9, "add r1, r1, #7");
    test_disasm(0x1dcf, "add r7, r1, #7");
    test_disasm(0x1df8, "add r0, r7, #7");
    test_disasm(0x1df9, "add r1, r7, #7");
    test_disasm(0x1dff, "add r7, r7, #7");
    ...
    test_disasm(0x1e40, "sub r0, r0, #1");
    test_disasm(0x1e41, "sub r1, r0, #1");
    test_disasm(0x1e47, "sub r7, r0, #1");
    test_disasm(0x1e48, "sub r0, r1, #1");
    test_disasm(0x1e49, "sub r1, r1, #1");
    test_disasm(0x1e4f, "sub r7, r1, #1");
    test_disasm(0x1e78, "sub r0, r7, #1");
    test_disasm(0x1e79, "sub r1, r7, #1");
    test_disasm(0x1e7f, "sub r7, r7, #1");
    test_disasm(0x1fc0, "sub r0, r0, #7");
    test_disasm(0x1fc1, "sub r1, r0, #7");
    test_disasm(0x1fc7, "sub r7, r0, #7");
    test_disasm(0x1fc8, "sub r0, r1, #7");
    test_disasm(0x1fc9, "sub r1, r1, #7");
    test_disasm(0x1fcf, "sub r7, r1, #7");
    test_disasm(0x1ff8, "sub r0, r7, #7");
    test_disasm(0x1ff9, "sub r1, r7, #7");
    test_disasm(0x1fff, "sub r7, r7, #7");

...
TEST(opcode, sxtb)
{
    ...
    sim.debug_store16(0x8002, 0xb258);      // sxtb r0, r3
    sim.debug_store16(0x8004, 0x4c04);      // ldr r4, [pc, #16]
    sim.debug_store16(0x8006, 0xb262);      // sxtb r2, r4
    sim.debug_store16(0x8008, 0x4d04);      // ldr r5, [pc, #16]
    sim.debug_store16(0x800a, 0xb26c);      // sxtb r4, r5
    sim.debug_store16(0x800c, 0x4f04);      // ldr r7, [pc, #16]
    sim.debug_store16(0x800e, 0xb27e);      // sxtb r6, r7

...
TEST(opcode, and)
{
    ...
    sim.debug_store16(0x8004, 0x4018);      //       ands r0, r3
    ...
    sim.debug_store16(0x800e, 0x4022);      //       ands r2, r4
    ...
    sim.debug_store16(0x8018, 0x402c);      //       ands r4, r5
    ...
    sim.debug_store16(0x8022, 0x403e);      //       ands r6, r7

...
TEST(opcode, asr_reg)
{
    ...
    sim.debug_store16(0x8004, 0x4118);      // asrs r0, r3
    ...
    sim.debug_store16(0x800e, 0x4122);      // asrs r2, r4
    ...
    sim.debug_store16(0x8018, 0x412c);      // asrs r4, r5
    ...
    sim.debug_store16(0x8022, 0x413e);      // asrs r6, r7

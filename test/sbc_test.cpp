...
TEST(opcode, sbc)
{
    ...
    sim.debug_store16(0x800a, 0x4198);      // sbcs r0, r3
    ...
    sim.debug_store16(0x8014, 0x41a2);      // sbcs r2, r4
    ...
    sim.debug_store16(0x801e, 0x41ac);      // sbcs r4, r5
    ...
    sim.debug_store16(0x8028, 0x41be);      // sbcs r6, r7

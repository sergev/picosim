...
TEST(opcode, eor)
{
    ...
    sim.debug_store16(0x8004, 0x4058);      // eors r0, r3
    ...
    sim.debug_store16(0x800e, 0x4062);      // eors r2, r4
    ...
    sim.debug_store16(0x8018, 0x406c);      // eors r4, r5
    ...
    sim.debug_store16(0x8022, 0x407e);      // eors r6, r7

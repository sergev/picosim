...
int main(int n, char **args) /* C REFERENCE MANUAL         */
{
...
int s26(struct defs *pd0)                  /*  2.6  Hardware Characteristics     */
{
...
int zero(){                 /* Returns a value of zero, possibly */
   static int k  __attribute__((unused)); /* with side effects, as it's called */
...
int s626(struct defs *pd0)          /* 6.2 Float and double                  */
...
int s757(struct defs *pd0)          /* 7.5 Shift operators          */
...
int s7813(struct defs *pd0)          /* 7.8 Bitwise AND operator
...
int regc() {     /*   char to register assignment   */
...
that the test is invalid.                                     */
            ...
            char r02;
            char r03;
   register char r04 __attribute__((unused));
            char r05;
   register char r06 __attribute__((unused));
            char r07;
   register char r08 __attribute__((unused));
            char r09;
   register char r10 __attribute__((unused));
            char r11;
   register char r12 __attribute__((unused));
            char r13;
   register char r14 __attribute__((unused));
            char r15;
   register char r16 __attribute__((unused));
            char r17;
   register char r18 __attribute__((unused));
            char r19;
   register char r20 __attribute__((unused));
            char r21;
   register char r22 __attribute__((unused));
            char r23;
   register char r24 __attribute__((unused));
            char r25;
   register char r26 __attribute__((unused));
            char r27;
   register char r28 __attribute__((unused));
            char r29;
   register char r30 __attribute__((unused));
            char r31;
   register char r32 __attribute__((unused));
            char r33;
   register char r34 __attribute__((unused));
            char r35;
            char r36;
            char r37;
            char r38;

   int s, n1, n2, nr = 0, j, d[22];
   r00 = 0;
   r01 = 1;
   r02 = 2;
   r03 = 3;
...
int regi() {     /*   int to register assignment    */
/*   Testing a variable whose storage class has been spec-
ified as "register" is somewhat tricky, but it can be done in a
fairly reliable fashion by taking advantage of our knowledge of the
ways in which compilers operate. If we declare a collection of vari-
...
that the test is invalid.                                     */
            ...
            int r02;
            int r03;
   register int r04 __attribute__((unused));
            int r05;
   register int r06 __attribute__((unused));
            int r07;
   register int r08 __attribute__((unused));
            int r09;
   register int r10 __attribute__((unused));
            int r11;
   register int r12 __attribute__((unused));
            int r13;
   register int r14 __attribute__((unused));
            int r15;
   register int r16 __attribute__((unused));
            int r17;
   register int r18 __attribute__((unused));
            int r19;
   register int r20 __attribute__((unused));
            int r21;
   register int r22 __attribute__((unused));
            int r23;
   register int r24 __attribute__((unused));
            int r25;
   register int r26 __attribute__((unused));
            int r27;
   register int r28 __attribute__((unused));
            int r29;
   register int r30 __attribute__((unused));
            int r31;
   register int r32 __attribute__((unused));
            int r33;
   register int r34 __attribute__((unused));
            int r35;
            int r36;
            int r37;
            int r38;
...
int regp() {     /*   pointer to register assignment   */
/*   Testing a variable whose storage class has been spec-
ified as "register" is somewhat tricky, but it can be done in a
fairly reliable fashion by taking advantage of our knowledge of the
ways in which compilers operate. If we declare a collection of vari-

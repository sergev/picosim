...
TEST(opcode, bic)
{
    ...
    sim.debug_store16(0x8004, 0x4398);      // bics r0, r3
    ...
    sim.debug_store16(0x800e, 0x43a2);      // bics r2, r4
    ...
    sim.debug_store16(0x8018, 0x43ac);      // bics r4, r5
    ...
    sim.debug_store16(0x8022, 0x43be);      // bics r6, r7

...
TEST(opcode, tst)
{
    ...
    sim.debug_store16(0x8004, 0x4218);      // tst r0, r3
    ...
    sim.debug_store16(0x800e, 0x4222);      // tst r2, r4
    sim.debug_store16(0x8010, 0xf3ef);      // mrs r3, CPSR
    sim.debug_store16(0x8012, 0x8300);
    sim.debug_store16(0x8014, 0x4c0a);      // ldr r4, [pc, #40]
    sim.debug_store16(0x8016, 0x43e5);      // mvns r5, r4
    sim.debug_store16(0x8018, 0x422c);      // tst r4, r5
    sim.debug_store16(0x801a, 0xf3ef);      // mrs r5, CPSR
    sim.debug_store16(0x801c, 0x8500);
    sim.debug_store16(0x801e, 0x4e09);      // ldr r6, [pc, #36]
    sim.debug_store16(0x8020, 0x4f09);      // ldr r7, [pc, #36]
    sim.debug_store16(0x8022, 0x423e);      // tst r6, r7
    ...
    sim.debug_store32(0x8048, 0xffff0000);

...
TEST(opcode, ror)
{
    ...
    sim.debug_store16(0x8004, 0x41d8);      // rors r0, r3
    ...
    sim.debug_store16(0x800e, 0x41e2);      // rors r2, r4
    ...
    sim.debug_store16(0x8018, 0x41ec);      // rors r4, r5
    ...
    sim.debug_store16(0x8022, 0x41fe);      // rors r6, r7

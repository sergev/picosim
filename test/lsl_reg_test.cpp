...
TEST(opcode, lsl_reg)
{
    ...
    sim.debug_store16(0x8004, 0x4098);      //       lsls r0, r3
    ...
    sim.debug_store16(0x800c, 0x241f);      //       movs r4, #31
    sim.debug_store16(0x800e, 0x40a2);      //       lsls r2, r4
    ...
    sim.debug_store16(0x8018, 0x40ac);      //       lsls r4, r5
    ...
    sim.debug_store16(0x8022, 0x40be);      //       lsls r6, r7

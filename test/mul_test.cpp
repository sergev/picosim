...
TEST(opcode, mul)
{
    ...
    sim.debug_store16(0x8004, 0x4358);      // muls r0, r3
    ...
    sim.debug_store16(0x800e, 0x4362);      // muls r2, r4
    ...
    sim.debug_store16(0x8018, 0x436c);      // muls r4, r5
    ...
    sim.debug_store16(0x8022, 0x437e);      // muls r6, r7
    ...
    sim.debug_store32(0x8030, 0x7502f000);
    sim.debug_store32(0x8034, 0xc0100000);
